...
;; This configuration was obtained from
;; https://gist.githubusercontent.com/nilsdeppe/7645c096d93b005458d97d6874a91ea9/raw/8bc87b2b5b062fcbf00ade74bcd4f4167c0de58a/emacs.el
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (powerline sourcerer-theme auctex markdown-mode yasnippet-snippets json-mode yaml-mode zzz-to-char yapfify writegood-mode window-numbering which-key wgrep web-mode vlf use-package string-inflection realgud rainbow-delimiters origami multiple-cursors monokai-theme monokai-alt-theme modern-cpp-font-lock memory-usage magit-gerrit kaolin-themes hungry-delete google-c-style git-gutter flyspell-correct-ivy flycheck-pyflakes elpy edit-server cuda-mode counsel-etags company-jedi cmake-mode clang-format beacon bazel-mode autopair auto-package-update))))
